		...
		Impact: reportmodel.ReviewImpactReport{
			Better: []reportmodel.ReviewImpactItem{
				...
				},
				{
					...
					ID:     "import|internal/adapter/cli/check.go|internal/platform/files/atomic.go",
					Detail: "internal/adapter/cli/check.go -> internal/platform/files/atomic.go (cli -> platform)",
				},
			},
		},
	})
